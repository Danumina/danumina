...
<html lang="sin">
  <head>
    ...
    <title>දැනුමිණ | නව ගිණුමක් ආරම්භ කිරීම</title>
            ...
            <div class="navbar-end">
              <div  id="dropdownMenu" class="navbar-item has-dropdown is-hoverable">
                  ...
                  <div class="navbar-dropdown">
                    ...
                    <a class="navbar-item" href="#">නව ගිණුමක් ආරම්භ කිරීම</a>
                    <a class="navbar-item" href="./buypaper.php">නව කලාපයක් මිලදී ගැනීම</a>
                  </div>
              </div>
