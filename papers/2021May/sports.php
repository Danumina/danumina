...
<html lang="sin">
  <head>
    ...
    <title>දැනුමිණ | ක්‍රීඩා පිටිය</title>
          ...
          <div class="row article-first-row">
            <div class="columns has-text-centered">
              <div class="column is-2">
                <a class="prev-article-btn " href="./world.php"><i class="fas fa-angle-double-left"></i> <strong>ලොව වටා තතු</strong></a>
              </div>
              <div class="column is-8">
                <p class="subtitle has-text-centered">සුමේරියානු ශිෂ්ටාචාරයෙන් එන බොක්සිං ක්‍රීඩාව</p>
              </div>
              <div class="column is-2">
                <a class="next-article-btn has-text-centered" href="./history.php"><strong>ලෝක ඉතිහාසය</strong> <i class="fas fa-angle-double-right"></i></a>
              </div>
            </div>
            <div class="columns">
