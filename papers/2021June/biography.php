          ...
          <div class="row article-first-row">
            <div class="columns has-text-centered">
              ...
              <div class="column is-8">
                <p class="subtitle has-text-centered">හොලිවුඩ් සිනෙමාවේ විනෝදාස්වාදයේ රජු ස්ටීවන් ස්පීල්බර්ග්  -  පළමු කොටස</p>
              </div>
              <div class="column is-2">
            ...
            <div class="content">
              ...
              <div class="columns">
                <!-- <div class="column is-3">
                  <figure>
                    <img src="./images/Steven-Spielberg/11.jpg">
                    <figcaption>
                      හූපී ගෝල්ඩ්බර්ග්, ද කලර් පර්පල් ( The Color Purple ) චිත්‍රපටයේ
                    </figcaption>
                  </figure>
                </div> -->
                <div class="column is-6">
