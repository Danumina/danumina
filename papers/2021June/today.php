...
<html lang="sin">
  <head>
    ...
    <title>දැනුමිණ | අද වැනි දවසක</title>
          ...
          <div class="row article-first-row">
            <div class="columns has-text-centered">
              <div class="column is-2">
                <a class="prev-article-btn " href="./country.php"><i class="fas fa-angle-double-left"></i> <strong>රටක වතගොත</strong></a>
              </div>
              <div class="column is-8">
                <p class="subtitle has-text-centered">අද වැනි දවසක</p>
              </div>
              <div class="column is-2">
                <a class="next-article-btn has-text-centered" href="./doyouknow.php"><strong>ඔබ දන්නවාද?</strong> <i class="fas fa-angle-double-right"></i></a>
              </div>
            </div>
            <div class="columns">
