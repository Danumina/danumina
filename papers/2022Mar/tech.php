<?php require_once '../../template/header.php'; ?>
    <script>
    document.title = 'දැනුමිණ | විදුනැණ';
    document.querySelector('[data-class=heading]').textContent = 'අභ්‍යවකාශ සුන්බුන්';
    document.querySelector('.prev-article-btn').lastElementChild.innerText = 'සංස්කෘතිකාංග';
    document.querySelector('.next-article-btn').firstElementChild.innerText = 'ජෛවගෝලය';
    document.querySelector('.prev-article-btn').setAttribute('href','./culture.php');
    document.querySelector('.next-article-btn').setAttribute('href','./biology.php');
    </script>
    <div class="columns">
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/2.jpg" loading='lazy'>
          <figcaption>
    ...
    <div class="columns">
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/7.png" loading='lazy'>
          <figcaption>
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/12.jpg" loading='lazy'>
          <figcaption>
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/5.jpg" loading='lazy'>
          <figcaption>
    ...
    <div class="columns">
      <div class="column is-9">
        ...
        <div class="columns">
          <div class="column is-8">
            <figure>
              <img  src="./images/space debris/10.jpg" loading='lazy'>
              <figcaption>
          ...
          <div class="column is-4">
            <figure>
              <img  src="./images/space debris/9.jpg" loading='lazy'>
              <figcaption>
      ...
      <div class="column is-3">
        <figure>
          <img  src="./images/space debris/1.jpg" loading='lazy'>
          <figcaption>
        ...
        <figure>
          <img  src="./images/space debris/3.jpg" loading='lazy'>
          <figcaption>
        ...
        <figure>
          <img  src="./images/space debris/13.jpg" loading='lazy'>
          <figcaption>
    ...
    <div class="columns">
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/8.jpg" loading='lazy'>
          <figcaption>
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/16.jpg" loading='lazy'>
          <figcaption>
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/11.jpg" loading='lazy'>
          <figcaption>
    ...
    <div class="columns">
      <div class="column is-5">
        <figure>
          <img  src="./images/space debris/14.jpg" loading='lazy'>
          <figcaption>
      ...
      <div class="column is-4">
        <figure>
          <img  src="./images/space debris/15.jpg" loading='lazy'>
          <figcaption>
