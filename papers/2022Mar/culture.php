<?php require_once '../../template/header.php'; ?>
    <script>
    document.title = 'දැනුමිණ | සංස්කෘතිකාංග';
    document.querySelector('[data-class=heading]').textContent = 'තායි ජල සැණකෙළිය - සොන්ක්රාන්';
    document.querySelector('.prev-article-btn').lastElementChild.innerText = 'ලෝක ඉතිහාසය';
    document.querySelector('.next-article-btn').firstElementChild.innerText = 'විදුනැණ';
    document.querySelector('.prev-article-btn').setAttribute('href','./history.php');
    document.querySelector('.next-article-btn').setAttribute('href','./tech.php');
    </script>
    <div class="columns">
