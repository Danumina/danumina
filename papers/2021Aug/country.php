          ...
          <div class="row article-first-row">
            <div class="columns has-text-centered">
              ...
              <div class="column is-8">
                <p class="subtitle has-text-centered">අධිරාජ්‍යයන්ගේ සොහොන්බිම වූ ඇෆ්ගනිස්ථානය  -  පළමු කොටස</p>
              </div>
              <div class="column is-2">
            ...
            <div class="content">
              ...
              <div class="columns">
                <div class="column is-4">
                  <figure>
                      <img src="./images/Afghanistan/1.jpg">
                      <figcaption>
                        ඇෆ්ගනිස්ථාන ධජය
                      </figcaption>
                  </figure>
                  <figure>
                      <img src="./images/Afghanistan/2.jpg">
                      <figcaption>
                        ඇෆ්ගනිස්ථානය මායිම්ව ඇත්තේ පකිස්තානය, ඉරානය ,තුර්ක්මෙනිස්තානය, උස්බෙකිස්තානය ටජිකිස්තානය සහ චීනය යන රටවලටයි.
                      </figcaption>
                  </figure>
              ...
              <div class="columns">
                <div class="column is-8">
                  ...
                  <p class="has-text-justified">
                    ඇෆ්ගනිස්ථානයේ සමස්ත වාරිමාර්ග පද්ධතිය රට තුළම අන්තර්ගතය. වර්ග සැතපුම් 32,000 (වර්ග කිලෝමීටර් 83,000) ක භූමි ප්‍රදේශයක් පුරා විහිදෙන ගංගා සමුහයකි. ප්‍රධාන නැගෙනහිර ඇළ වන කෝබුල් ගඟ පාකිස්තානයේ ඉන්දු ගඟට ගලා බසින අතර එය ඉන්දියානු සාගරයේ අරාබි මුහුදට වැටේ.
                  </p>

                  <figure>
                    <img src="./images/Afghanistan/4.jpg">
                    <figcaption>
                      කෝබුල් ගඟ
                    </figcaption>
                  </figure>
                ...
                <div class="column is-4">
                  <figure>
                    <img src="./images/Afghanistan/3.jpg">
                    <figcaption>
                      කාබුල් අගනුවර - මිලියන 4.5ක පමණ ජනගහනයක් ජීවත්වේ.
                    </figcaption>
                  </figure>
                </div>
              </div>
              <p class="has-text-justified">
                රටේ අනෙකුත් වැදගත් ගංගා සියල්ලම පාහේ මධ්‍යම කඳුකර කලාපයෙන් ආරම්භ වන අතර මිරිදිය විල් වලට හිස්වී හෝ වැලි කාන්තාරවලදී වියළී යයි. ප්‍රධාන ජලාපවහන පද්ධති වන්නේ අමු දාරියා, හෙල්මන්ඩ්, කාබුල් සහ හරෝඩ් ය.
              </p>
              ...
              <p class="has-text-justified">
                ...
                ඇෆ්ගනිස්ථානයේ උෂ්ණත්වය බොහෝ සෙයින් වෙනස් වේ. නියඟයෙන් පීඩා විඳින නිරිතදිග සානුව කලාපයේ දිවා කාලයේ උෂ්ණත්වය 95° F (35° C) ට වඩා ඉහළ අගයක් ගනී.
              </p>

              <div class="columns">
                <div class="column is-6">
                  <figure>
                    <img src="./images/Afghanistan/5.jpg">
                    <figcaption>
                      ශීත සෘතුවේ ක්‍රීඩාවේ යෙදෙන ඇෆ්ගන් තරුණයින්
                    </figcaption>
                  </figure>
                </div>
                <div class="column is-6">
                  <figure>
                    <img src="./images/Afghanistan/6.jpg">
                    <figcaption>
                      නියං සමයේදී ජලය රැස් කරන ඇෆ්ගන් ළමුන්
                    </figcaption>
                  </figure>
                </div>
              </div>
              ...
              <p class="has-text-justified">
                රටේ උණුසුම්ම ප්‍රදේශවලින් එකක් වන ජලලාබාද්හි ඉහළම උෂ්ණත්වය 120° F (49° C) ලෙස ජූලි මාසයේදී වාර්තා වී තිබේ. උස් කඳුකර ප්‍රදේශවල ජනවාරි මාසයේදී උෂ්ණත්වය 5° F (−15° C) හෝ ඊට අඩු විය හැකි අතර අඩි 5,900 (මීටර් 1,800)ක උසින් පිහිටා ඇති කාබුල් නගරයේ එය −24° F (−31 ° C) උෂ්ණත්වයක් වාර්තා වී ඇත.
              </p>
              ...
              <div class="columns">
                <div class="column is-8">
                  ...
                  <div class="columns">
                    <div class="column is-6">
                      <figure>
                        <img src="./images/Afghanistan/8.jpg">
                        <figcaption>
                          ඉරි සහිත හයිනා
                        </figcaption>
                      </figure>
                    ...
                    <div class="column is-6">
                      <figure>
                        <img src="./images/Afghanistan/9.jpg">
                        <figcaption>
                          ඇෆ්ගන්  මාකෝ පෝලෝ බැටළුවන්
                        </figcaption>
                      </figure>
                    </div>
                  </div>
                ...
                <div class="column is-4">
                  <figure>
                    <img src="./images/Afghanistan/7.jpg">
                    <figcaption>
                      ඇෆ්ගන් ජාතික සත්වයා වන හිම දිවියා
                    </figcaption>
                  </figure>
                  <p class="has-text-justified">
                    ගංගා, ඇළ දොළ සහ විල් වල මිරිදිය මසුන් වර්ග රාශියක් සිටී, ගංගාවල දුඹුරු පැහැති ට්‍රවුට් මත්ස්‍යයින් විශාල වශයෙන් සිටී.
                  </p>
                </div>
              </div>
              <p class="has-text-justified">
                ගොදුරු කුරුල්ලන් ලෙස උකුස්සන්, රාජාලීන් ඇතුළත් වේ. සංක්‍රමණික පක්ෂීන් වසන්ත කාලවලදී බහුලව සිටිති.
                වළි කුකුලන්, වටුවන්, කොකුන්, පෙලිකන් කුරුල්ලන් සහ කකුළුවන් ද ඇත.
              </p>
              ...
              <div class="columns">
                <div class="column is-8">
                  <p class="has-text-justified">
                    1979 දී අර්ධ වශයෙන් ගණන් කිරීමෙන් පසු ඇෆ්ගනිස්ථානයේ කිසිදු ජාතික සංගණනයක් සිදු කර නොමැති අතර, වසර ගණනාවක යුද්ධය සහ ජනගහනය අවතැන්වීම නිසා නිවැරදි ජනවාර්ගික ගණනය කිරීමක් කළ නොහැකි විය. එබැවින් වර්තමාන ජනගහන ඇස්තමේන්තු දළ ගණනය කිරීම් වන අතර ඒවායින් පෙන්නුම් කරන්නේ පෂ්තුන් ජනවර්ගය ජනගහනයෙන් පහෙන් දෙකක් පමණ වන බවයි. විශාලතම පෂ්තුන් කණ්ඩායම් දෙක වන්නේ ඩුරෙනේ(Durrānī) සහ ගිල්සේ(Ghilzay) ය.
                  </p>
                  <p class="has-text-justified">
                    ටජික්වරු ඇෆ්ගනිස්තානුවන්ගෙන් හතරෙන් එකක් පමණ විය හැකි අතර, හසාරා සහ උස්බෙකිස්තානුවන් ඉන් දහයෙන් එකක් පමණ වේ. චහාර් අයිමක්ස්, ටර්ක්මන් සහ අනෙකුත් ජනවාර්ගික කණ්ඩායම් සුළු කොටස් වේ.
                  </p>
                </div>
                <div class="column is-4">
                  <figure>
                    <img src="./images/Afghanistan/11.jpg">
                    <figcaption>
                      මල් රැඳවු හිස් වැස්මක් පැළඳි පෂ්තුන් ජනවර්ගයට අයත් තරුණයෙක්
                    </figcaption>
                  </figure>
                </div>
              </div>
              ...
              <br><h6>භාෂා</h6>
              <p class="has-text-justified">
                ඇෆ්ගනිස්ථානයේ ජනතාව ජනවාර්ගික හා භාෂාමය වශයෙන් සංකීර්ණ වේ. ඉන්දු-යුරෝපීය භාෂා දෙකම වන පැෂ්ටෝ සහ පර්සියානු (ඩාරි) රටේ නිල භාෂා වේ. ජනගහනයෙන් පහෙන් දෙකකට වඩා වැඩි ප්‍රමාණයක් පෂ්තුන්වරුන්ගේ භාෂාව වන පැෂ්ටෝ කතා කරන අතර අඩක් පමණ පර්සියානු බස කතා කරයි.
              </p>

              <div class="columns">
                <div class="column is-4">
                  <figure>
                    <img src="./images/Afghanistan/12.jpg">
                    <figcaption>
                      හසාරා ජනවර්ගයට අයත් ළමුන් පිරිසක්
                    </figcaption>
                  </figure>
                </div>
                <div class="column is-8">
                  <p class="has-text-justified">
                    පර්සියානු භාෂාවේ ඇෆ්ගනිස්ථාන උපභාෂාව සාමාන්‍යයෙන් “ඩාරි” ලෙස හැඳින්වුවද, ටජික්, හාසරා, චහාර් අයිමාක් සහ කිසිල්බාෂ් ජනයා අතර උපභාෂා ගණනාවක් කථා කරයි. ඉරානයේ (ෆාර්සි) හෝ පර්සියානු භාෂාවට වඩා සමීපව කතා කරන උපභාෂා ද ඇතුළුව. පර්සියානු භාෂාව ටජිකිස්තානයේ (ටජික්) කතා කරයි.
                  </p>
                  <p class="has-text-justified">
                    ඩාරි සහ ටජික් උපභාෂාවල තුර්කි සහ මොන්ගෝලියානු වචන ගණනාවක් අඩංගු වන අතර, භාෂා දෙකක් හෝ කිහිපයක් කතා කිරීම සුලභය, සමහර පෂ්තුන් නොවන අය පැෂ්ටෝ භාෂාව කථා කරන අතර, විශේෂයෙන් නාගරික ප්‍රදේශවල පෂ්තුන් විශාල සංඛ්‍යාවක් පර්සියානු භාෂාව කතා කරන අවස්ථාද ඇත.
                  </p>
                </div>
              </div>
              ...
              <div class="columns">
                ...
                <div class="column is-6">
                  <figure>
                    <img src="./images/Afghanistan/13.jpg">
                    <figcaption>
                      මසාර් ඒ ෂරීෆ් හි ඇති මුස්ලිම්වරුන්ගේ සුප්‍රසිද්ධ නිල් පල්ලිය
                    </figcaption>
                  </figure>
                </div>
              </div>
